...
public class PositionGridGenerator {
    ...
    double xSpace; double ySpace; double maxX;
    
    /**
     * Create a new PositionGridGenerator.
     * @param xSpace The step size in X-direction.
     * @param ySpace The step size in Y-direction.
     * @param maxX The maximum X-coordinate, if exceeded, a new row will be started. 
     */
