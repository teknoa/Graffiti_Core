 ...
 * two sets are not ordered. A <code>Graph</code> is considered directed iff
 * all its edges are directed, undirected iff all its edges are undirected. A
 * <code>Graph</code> may contain directed and undirected edges. It can only
 * be directed and undirected at the same time iff it is empty. Graphs can be
 ...
 * 
 * <p>
 * <b>Implementation notes:</b> For example, the method <code>xy()</code> of
 * any <code>Graph</code> implementation will have to look as follows:
 * <blockquote>
 * <pre>
 * public whatever xy() {
    ...
    extends Attributable, DeepCopy
{
    ...
    /**
     * Returns the <code>AttributeTypesManager</code> of the
     * <code>Graph</code>.
     *
     * @return the <code>AttributeTypesManager</code> of the
     *         <code>Graph</code>.
     */
    public AttributeTypesManager getAttTypesManager();

    /**
     * Indicates whether the <code>Graph</code> is directed. 
     * A <code>Graph</code> is directed if all the edges are directed.
     *
    ...
    /**
     * Indicates whether the <code>Graph</code> has been modified.
     * A call to <code>setModified</code> can change this property to false
     * e.g. after the graph has been saved to disc.
     * Changes to attributes and delete/add commands of nodes and edges
     * should change this property to <code>true</code>.
     ...
     * @param modified Indicates the new status of this field.
     */
     ...
     * When passing a true value, all undirected edges in the graph will be 
     * set to be directed. V.v. for a false value.
     * A true second parameter indicates that all edges shall get one arrow
     * at their tips (i.e. close to the target node).
     * 
     * @param directed
     * @param adjustArrows
     */
     ...
     *         n2, an empty collection if there is no <code>Edge</code>
    ...
    /**
     * Returns a <code>java.util.List</code> containing all the nodes of
     * the <code>Graph</code>.
     *
     * @return a <code>java.util.List</code> containing all the nodes of
     *         the <code>Graph</code>.
     */
     ...
     *
     * @param source the source of the <code>Edge</code> to add.
     * @param target the target of the <code>Edge</code> to add.
     * @param directed <code>true</code> if the <code>Edge</code> shall be
     ...
     * @param directed <code>true</code> if the <code>Edge</code> shall be
     *        directed, <code>false</code> otherwise.
     * @param col the <code>CollectionAttribute</code> this edge is initialized
     *        with.
     *
     * @return the newly generated <code>Edge</code>.
     *
     ...
     * <code>Edge</code>. Also informs the ListenerManager about the copy of
     * the attributes added to the <code>Edge</code>.
     *
     * @param edge the <code>Egde</code> which to copy and add.
     * @param source the source <code>Node</code> of the copied and added
     *        <code>Edge</code>.
     * @param target the target <code>Node</code> of the copied and added
     *        <code>Edge</code>.
     *
     * @return DOCUMENT ME!
     */
     ...
     * <Code>Graph</Code> g will be copied and then all its nodes and edges
     * will be added to the current <code>Graph</code>. Like this g will not
     * be destroyed.
     *
     * @param g the <Code>Graph</Code> to be added.
     */
    ...
    /**
     * Adds a copy of the specified <code>Node</code> to the
     * <code>Graph</code>. Informs the ListenerManager about the newly added
     * <code>Node</code> in the same way as if a completely new
     * <code>Node</code> was added. Also informs the ListenerManager about the
     ...
     *
     * @param e the <code>Edge</code> to seach for
     *
     ...
     *
     * @param n the <code>Node</code> to search for.
     *
     * @return <code>true</code>, if the <code>Graph</code> contains the
     ...
     *
     * @param e the <code>Edge</code> to delete.
     *
     * @exception GraphElementNotFoundException if the <code>Edge</code> to
     *            delete cannot be found in the <code>Graph</code>.
     */
     ...
     *
     * @param n the <code>Node</code> to delete.
     *
     * @exception GraphElementNotFoundException if the <code>Node</code> to
     *            delete cannot be found in the <code>Graph</code>.
     */
	 ...
	 * @param name A ID that can be used for identifying the graph - for the user or for the developer.
	 */
	public void setName(String name);
	
	/**
	 * @return 	A ID that can be used for identifying the graph - for the user or for the developer. 
	 * The name can be set with the method <code>setName</code>.
	 * Calls <code>getName(false)</code> to return a short name. E.g. just the filename
	 * and not the full name with file path.
	 */
