...
//
//==============================================================================
// $Id: AbstractGraphElement.java,v 1.4 2009/08/21 08:26:19 klukas Exp $
...
//    static protected final Logger logger = Logger.getLogger(AbstractGraphElement.class.getName());
     ...
     * Constructs a new <code>AbstrctGraphElement</code>.
     *
     * @param coll the <code>CollectionAttribute</code> of the new
     ...
     *
     * @param graph the graph the <code>AbstrctGraphElement</code> belongs to.
     * @param coll the <code>CollectionAttribute</code> of the new
     *        <code>AbstractGraphElement</code> instance.
     */
