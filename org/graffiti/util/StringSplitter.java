...
//
//==============================================================================
// $Id: StringSplitter.java,v 1.1 2007/05/31 12:56:03 klukas Exp $
...
public class StringSplitter
{
     ...
     * delimeter. Fills the returned String array with the results.  If
     * <code>delim</code> does not appear in <code>toSplit</code>, the whole
     * String is returned as first entry of the returned String array.
     *
     * @param toSplit the String that is split.
     * @param delim the String that is used as delimiter.
     *
     ...
     * @param toSplit the String that is split.
     * @param delim the String that is used as delimiter.
     * @param limit the maximum number of resulting Strings
     *
     * @return the parts of the String in a String array.
     */
     ...
     * the returned String array.  This method is faster than a call to
     * <code>split(toSplit, delim, 2)</code>, but otherwise has the same
     * result.
     *
     * @param toSplit the String that is split.
     * @param delim the String that is used as delimiter.
