...
//
//==============================================================================
// $Id: AbstractEdgeListener.java,v 1.1 2007/05/31 12:56:05 klukas Exp $
 ...
 * <code>EdgeListener</code> interface, you have to define all of the methods
 * in it. This abstract class defines <code>null</code> methods for them all,
 * so you can only have to define methods for events you care about.)
 * </p>
 * 
 * <p>
 * Create a listener object using the extended class and then register it with
 * a component using the component's <code>addEdgeEventListener</code> method.
 * When the structure of the graph is changed (e.g.: an edge is added,
 * reversed, an edge's source or target node changes, or an edge is removed)
 * or a transaction of graph structure changes is started or finished, the
 * relevant method in the listener object is invoked and the
 * <code>EdgeEvent</code> is passed to it.
 * </p>
 *
