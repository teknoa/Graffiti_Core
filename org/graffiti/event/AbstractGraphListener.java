 ...
 * a component using the component's <code>addGraphEventListener</code>
 * method. When the structure of the graph object is changed or a transaction
 * of graph changes is started or finished, the relevant method in the
