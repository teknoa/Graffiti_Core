...
//
//==============================================================================
// $Id: Attribute.java,v 1.3 2010/07/19 12:59:19 morla Exp $
...
DeepCopy {
	 ...
	 * is <code>null</code> before. Normaly only <code>addAttribute()</code>
	 * methods should call it.
	 *
	 * @param parent the <code>Attribute</code>'s parent.
	 *
	 * @exception FieldAlreadySetException if the parent was already set before
	 */
