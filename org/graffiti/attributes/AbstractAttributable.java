...
public abstract class AbstractAttributable implements Attributable {
     ...
     * calls to method <code>add(Attribute a)</code> in
     ...
     * @param value the value to set the <code>Attribute</code> to.
     */
     ...
     * The<code>Attribute</code>is created at the given location, if it does
     * not yet exist. Appropriate (add and change) events are generated by
     * calls of method <code>add(Attribute a)</code> in
     * <code>CollectionAttribute</code> and method <code>setValue(Object
     * o)</code> in <code>Attribute</code>. If more than one attributes have
     * to be created while stepping down the path, only one event is
     * generated, containing the attribute that has been created first (i.e.
     ...
     * the <code>CollectionAttribute</code> or (in case <code>path</code> is
     * the empty string) the Attributable <code>attr</code> should be added
     * to. Usage should look as follows:
     * <blockquote>
     * <pre>
     * Graph g = new Graph(..);
     ...
     *            at location <code>path</code> is not a CollectionAttribute.
     ...
     * @param id the id of the new <code>IntegerAttribute</code>.
     * @param value the value of the new <code>IntegerAttribute</code>.
     *
     * @exception NoCollectionAttributeException if the <code>Attribute</code>
     *            at the location specified by <code>path</code> is no
     *            <code>CollectionAttribute</code>.
     * @exception AttributeExistsException if there is already an attribute
     *            with the given <code>id</code> at the given
     *            <code>path</code>.
     * @throws FieldAlreadySetException DOCUMENT ME!
     */
     ...
     * <code>CollectionAttribute</code>.
     *
     * @param path the relative path of the<code>Attribute</code>to be removed.
     *
     * @exception AttributeNotFoundException if there is no
     *            <code>Attribute</code> at the location specified by
     *            <code>path</code>.
     ...
     * the root attribute of the newly appended hierarchy).
     *
     * @param path the path where the <code>Attribute</code> shall be set.
     * @param o the <code>Object</code> which shall be set.
     * @param attributeType indicates the type of<code>Attribute</code> to set.
     *
     * @throws NoCollectionAttributeException DOCUMENT ME!
     * @throws AttributeExistsException DOCUMENT ME!
     */
