...
//
//==============================================================================
// $Id: CompositeAttribute.java,v 1.1 2007/05/31 12:55:53 klukas Exp $
    ...
    extends AbstractAttribute
{
     ...
     *
     * @param att the <code>Attribute</code> containing the new value for the
     *        value asociated with the given id.
     * @param id the id of the attribute to be set.
     *
     * @exception AttributeNotFoundException if there is no value associated
     *            with the given id.
     * @exception IllegalArgumentException if <code>att</code> has not the
     *            appropriate type.
     */
     ...
     * This representation is intended to be read-only - changes to the
     ...
     * <code>CompositeAttribute</code>.
     *
     * @param id the id of the attribute searched for.
     *
     * @return the attribute with the given id.
     *
     * @exception AttributeNotFoundException if the searched attribute is not
     *            found.
     */
