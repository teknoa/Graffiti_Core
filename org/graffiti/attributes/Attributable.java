...
//
//==============================================================================
// $Id: Attributable.java,v 1.1 2007/05/31 12:55:54 klukas Exp $
...
public interface Attributable
{
     ...
     *
     * @param path the path to the <code>Attribute</code>.
     *
     * @return DOCUMENT ME!
     *
     ...
     * not yet exist.
     *
     * @param path the path to search for the <code>Attribute</code>.
     * @param value the value to set to the <code>Attribute</code> to.
     */
     ...
     *
     * @exception AttributeNotFoundException if there is no
     *            <code>Attribute</code> at the specified location.
     */
     ...
     * <code>preAttributeAdded</code> and <code>postAttributeAdded</code> in
     * the ListenManager. Also sets the <code>parent</code> and the
     ...
     * </p>
     *
     * @param attr the <code>Attribute</code> to be added.
     *
     * @exception AttributeExistsException if there is already an
     *            <code>Attribute</code> with the same <code>id</code> as
     *            <code>attr</code> at location  <code>path</code>.
     * @exception NoCollectionAttributeException if the <code>Attribute</code>
     *            at location <code>path</code> is not a
     *            <code>CollectionAttribute</code>.
     */
     ...
     *
     * @param path the path to the <code>CollectionAttribute</code> the new
     *        IntegerAttribute should be added to.
     * @param id the id of the newly created <code>Attribute</code>.
     * @param value the value of the newly created <code>Attribute</code>.
     *
     * @exception NoCollectionAttributeException if the <code>Attribute</code>
     *            at the location specified by <code>path</code> is no
     *            <code>CollectionAttribute</code>.
     * @exception AttributeExistsException if there is already an
     *            <code>Attribute</code> with the given <code>id</code> at the
     ...
     * @param id the id of the new ByteAttribute.
     * @param value the value of the new ByteAttribute.
     *
     * @exception NoCollectionAttributeException if the <code>Attribute</code>
     *            at the location specified by <code>path</code> is no
     *            <code>CollectionAttribute</code>.
     ...
     * @param path the path to the <code>CollectionAttribute</code> the new
     *        IntegerAttribute should be added to.
     * @param id the id of the new IntegerAttribute.
     * @param value the value of the new IntegerAttribute.
     *
     * @exception NoCollectionAttributeException if the <code>Attribute</code>
     *            at the location specified by <code>path</code> is no
     *            <code>CollectionAttribute</code>.
     ...
     * @param id the id of the new LongAttribute.
     * @param value the value of the new LongAttribute.
     *
     * @exception NoCollectionAttributeException if the <code>Attribute</code>
     *            at the location specified by <code>path</code> is no
     *            <code>CollectionAttribute</code>.
     ...
     * @param id the id of the new ShortAttribute.
     * @param value the value of the new ShortAttribute.
     *
     * @exception NoCollectionAttributeException if the <code>Attribute</code>
     *            at the location specified by <code>path</code> is no
     *            <code>CollectionAttribute</code>.
