...
//
//==============================================================================
// $Id: AbstractAttribute.java,v 1.13 2010/11/16 13:41:22 morla Exp $
...
implements Attribute
{
	 ...
	 *
	 * @param id the id of the <code>AbstractAttribute</code>.
	 *
	 * @exception IllegalIdException if the given id contains a separator.
	 */
	 ...
	 * added to the hierarchy.  Therefore no event is generated by this
	 * method.
	 * </p>
	 *
	 * @param parent the new parent of the <code>Attribute</code>.
	 *
	 ...
	 *
	 * @exception IllegalArgumentException if v is not of the apropriate type.
	 */
	 ...
	 * has been added.
	 *
	 * @param ae the <code>Attribute</code> which will be sent to the
	...
	/**
	 * Informs the <code>ListenerManager</code> before an
	 * <code>Attribute</code> will be added.
	 *
	 * @param ae the <code>Attribute</code> which will be sent to the
	 *        <code>ListenerManager</code>.
	 */
	...
	/**
	 * Informs the <code>ListenerManager</code> before an
	 * <code>Attribute</code> will be removed.
	 *
	 * @param ae the <code>Attribute</code> which will be sent to the
	 *        <code>ListenerManager</code>.
	 */
