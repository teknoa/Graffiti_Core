...
//
//==============================================================================
// $Id: NodeGraphicAttribute.java,v 1.4 2010/07/19 13:01:00 morla Exp $
...
extends GraphElementGraphicAttribute
{
	 ...
	 * @param d the dimension-value of the attribute.
	 * @param p the ports-value of the attribute.
	 *
	 ...
	 * Constructor for NodeGraphicAttribute.
	 *
	 * @param x the x-coordinate-value of the attriubte.
	 * @param y the y-coordinate-value of the attriubte.
	 * @param h the height-value of the attribute.
	 * @param w the width-value of the attribute.
	 * @param p the ports-value of the attribute.
	 *
	 * @throws IllegalIdException
	 */
	 ...
	 *
	 * @param c the 'coordinate'-value to be set.
	 */
	 ...
	 *
	 * @param d the 'dimension'-value to be set.
	 */
	 ...
	 *
	 * @param p the 'ports'-value to be set.
	 */
