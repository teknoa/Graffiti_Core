...
//
//==============================================================================
// $Id: PortAttribute.java,v 1.3 2010/07/17 22:00:20 klukas Exp $
    ...
    implements GraphicAttributeConstants
{
     ...
     *
     * @param id the id of the attribute.
     * @param n the name-value of the attribute.
     * @param c the coordinate-value of the attribute.
     */
     ...
     * @param id the id of the attribute.
     * @param n the name-value of the attribute.
     * @param x the x-coordinate-value of the attribute.
     * @param y the y-coordinate-value of the attribute.
     */
     ...
     * Sets the 'port'-value.
     *
     * @param c the 'port'-value to be set.
     */
     ...
     * Sets the 'name'-value.
     *
     * @param n the 'name'-value to be set.
     */
