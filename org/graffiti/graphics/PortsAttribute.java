...
//
//==============================================================================
// $Id: PortsAttribute.java,v 1.6 2010/07/19 13:00:57 morla Exp $
...
implements GraphicAttributeConstants
{
	 ...
	 *
	 * @param id the id of the attribute.
	 * @param i the ingoing-value of the attribute.
	 * @param o the outgoing-value of the attribute.
	 * @param c the common-value of the attribute.
	 */
	 ...
	 *
	 * @param c the 'common'-value to be set.
	 */
	 ...
	 *
	 * @param i the 'ingoing'-value to be set.
	 */
	 ...
	 *
	 * @param o the 'outgoing'-value to be set.
	 */
	 ...
	 *
	 * @param name the name of the port attribute wanted.
