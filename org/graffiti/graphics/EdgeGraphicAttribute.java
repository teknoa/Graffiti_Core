...
//    private StringAttribute lineType;
     ...
     *
     * @param ah the arrowhead-value of the attribute.
     * @param at the arrowtail-value of the attribute.
     * @param t the thickness-value of the attribute.
     * @param d the docking-value of the attribute.
     * @param b the <code>CollectionAttriubte</code> containing the bends.
     * @param lt the lineType of the edge.
     */
     ...
     *
     * @param ah the 'arrowhead'-value to be set.
     */
     ...
     *
     * @param at the 'arrowtail'-value to be set.
     */
     ...
     *
     * @param b the 'bends'-value to be set.
     */
     ...
     *
     * @param d the 'docking'-value to be set.
     */
     ...
     *
     * @param t the 'thickness'-value of the encapsulated edge.
     */
