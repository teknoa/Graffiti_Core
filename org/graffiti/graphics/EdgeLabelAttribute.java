...
//
//==============================================================================
// $Id: EdgeLabelAttribute.java,v 1.5 2010/07/19 13:01:00 morla Exp $
 ...
 *
 * @author holleis
 * @version $Revision: 1.5 $ Extends LabelAttribute by a PositionAttribute specific for edges.
 */
public class EdgeLabelAttribute extends LabelAttribute
{
	...
	public void setCollection(Map<String, Attribute> attrs)
	{
		...
		)
		{
			for (Iterator<String> it = attrs.keySet().iterator(); it.hasNext();)
			{
				...
				else if (attrId.equals(ANCHOR))
				{
					setAlignment(((StringAttribute) attrs.get(ANCHOR)).getString());
				}
				else if (attrId.equals(FONTNAME))
				{
	 ...
	 *
	 * @param p the 'position'-value to be set.
	 */
