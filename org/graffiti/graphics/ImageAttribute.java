...
//
//==============================================================================
// $Id: ImageAttribute.java,v 1.4 2010/07/19 13:00:57 morla Exp $
...
implements GraphicAttributeConstants
{
	 ...
	 *
	 * @param id the id of the attribute.
	 * @param t the tiled-value of the attribute.
	 * @param m the maximize-value of the attribute.
	 * @param i the image-value of the attribute.
	 * @param r the reference-value of the attribute.
	 */
	 ...
	 * @param t the tiled-value of the attribute.
	 * @param m the maximize-value of the attribute.
	 * @param i the java.awt.image-value of the attribute.
	 * @param r the reference-value of the attribute.
	 */
	 ...
	 *
	 * @param i the 'image'-value to be set.
	 */
	 ...
	 *
	 * @param m the 'maximize'-value to be set.
	 */
	 ...
	 *
	 * @param r the 'reference'-value to be set.
	 */
	 ...
	 *
	 * @param t the 'tiled'-value to be set.
	 */
