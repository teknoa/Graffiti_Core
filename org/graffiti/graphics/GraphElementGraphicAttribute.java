...
//
//==============================================================================
// $Id: GraphElementGraphicAttribute.java,v 1.1 2007/05/31 12:55:58 klukas Exp $
    ...
    implements GraphicAttributeConstants
{
     ...
     * @param i the backgroundimage-value of the attriubte
     * @param frc the framecolor-value of the attribute.
     * @param fic the fillcolor-value of the attribute.
     * @param l DOCUMENT ME!
     * @param ft the framethickness-value of the attribute.
     * @param lm the linemode-value of the attribute.
     * @param s DOCUMENT ME!
     *
     * @throws IllegalIdException
     */
     ...
     *
     * @param bgi the 'backgroundimage'-value to be set.
     */
     ...
     *
     * @param fic the 'fillcolor'-value to be set.
     */
     ...
     *
     * @param ft the 'frameThickness'-value to be set.
     */
     ...
     *
     * @param frc the 'framecolor'-valueto be set.
     */
     ...
     *
     * @param lma the 'lineMode'-value to be set.
     */
     ...
     *
     * @param sn the 'shape'-value to be set.
     */
