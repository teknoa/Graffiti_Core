...
//
//==============================================================================
// $Id: ColorAttribute.java,v 1.4 2010/07/19 13:01:00 morla Exp $
...
implements GraphicAttributeConstants, ColorSetAndGetSupport
{
	 ...
	 * @param c the color-value of the attribute.
	 */
	 ...
	 *
	 * @param id the id of the attribute.
	 * @param r the red-value of the attribute.
	 * @param g the green-value of the attribute.
	 * @param b the blue-value of the attribute.
	 * @param t the opacity-value of the attribute.
	 */
	 ...
	 * Sets the 'blue'-value.
	 *
	 * @param b the 'blue'-value to be set.
	 */
	 ...
	 * <tt>CollectionAttribute</tt>. The color values are set, additional
	 ...
	 *
	 * @param c the java.awt.Color value.
	 */
	 ...
	 *
	 * @param g the 'green'-value to be set.
	 */
	 ...
	 *
	 * @param t the 'opacity'-value to be set.
	 */
	 ...
	 * Sets the 'red'-value.
	 *
	 * @param r the 'red'-value to be set.
	 */
